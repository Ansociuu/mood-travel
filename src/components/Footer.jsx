    ...
    <footer style={{ background: "#ffffff", borderTop: "1px solid rgba(0,0,0,0.05)", padding: "64px 40px 32px", color: "#475569" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "40px", marginBottom: "40px" }}>
          ...
          {[
            ["Khám phá", ["Tour miền Bắc", "Tour miền Trung", "Tour miền Nam", "Tour quốc tế"]], 
            ["Dịch vụ", ["Homestay", "Khách sạn", "Vé máy bay", "Bảo hiểm du lịch"]], 
            ["Hỗ trợ", ["Trung tâm trợ giúp", "Chính sách hoàn tiền", "Điều khoản", "Liên hệ"]]
          ].map(([title, links]) => (
            <div key={title}>
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#0f172a", marginBottom: "20px", textTransform: "uppercase", letterSpacing: "0.5px" }}>{title}</div>
              {links.map(link => (
